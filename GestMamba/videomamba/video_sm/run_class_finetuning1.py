...
JOB_NAME = 'Mamba_small_depth_f32_b3_s123'
...
def get_args():
    ...
    # Model parameters
    parser.add_argument('--model', default='videomamba_small', type=str, metavar='MODEL',
    ...
    # Finetuning params
    parser.add_argument('--finetune', default='./weights/videomamba_s16_k400_f32_res224.pth', help='finetune from checkpoint')
    ...
    parser.add_argument('--filename_tmpl', default='{:06}.jpg', type=str,
                        help='general:{:06}.jpg; FPHA:color_{:04}.jpeg, depth_{:04}.png')
    parser.add_argument('--data_path', default='./dataset_splits/EgoGesture/depth', type=str,
                        help='dataset path')

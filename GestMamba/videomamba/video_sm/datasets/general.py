...
class SMRawFrameClsDataset(Dataset):
    ...
    def __getitem__(self, index):
        if self.mode == 'train':
            ...
            return buffer, self.label_array[index], sample_id
            ...
            total_frame = self.test_total_frames[index] - 1
            ...
            buffer = self.data_transform(buffer)
            return buffer, self.test_label_array[index], sample_id, \
                   chunk_nb, split_nb
        else:
...
class SMVideoClsDataset(Dataset):
